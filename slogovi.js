...
function naslov() {
        ...
        if (vw < 450) {
            document.getElementById("naslov").innerHTML = "<img  src=\"./naslov.png\" width=\"320px\" height=\"28px\">";
        } else {
            document.getElementById("naslov").innerHTML = "<img  src=\"./naslov.png\" width=\"450px\" height=\"35px\">";      
        }
};
function naslovCyr() {
    document.getElementById("naslov").innerHTML = "ПO|ДЕ|ЛИ|  НА|  СЛО|ГО|ВЕ";
}

function defNaslov() {
    
    document.getElementById("naslov").innerHTML = "PODELI NA SLOGOVE";
    
    
};
function defNaslovCyr() {
    document.getElementById("naslov").innerHTML = "ПОДЕЛИ НА СЛОГОВЕ";
}
